...
class View
{
    ...
    public static function render(string $view, ?array $data = null, bool $buffer = true, string $ext = '.php'): string
    {
        ...
        $dataVars = [
            'data' => array_merge($data ?? [], self::$tempData),
        ];

        $output  = self::captureFile($file, $dataVars['data'], $buffer);
    ...
    public static function getView(string $view, array $params = [], bool $buffer = true, string $ext = '.php')
    {
